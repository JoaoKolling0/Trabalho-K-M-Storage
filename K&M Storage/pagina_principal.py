...
def abrir_pagina_principal():
    ...
    # Botões principais
    tk.Button(janela, text="Enviar mercadoria\npara o estoque", font=("Arial", 14, "bold"), bg="#154360", fg="white",
              width=20, height=4, bd=3, relief="solid").place(x=350, y=100)

    tk.Button(janela, text="Retirar mercadoria\ndo estoque", font=("Arial", 14, "bold"), bg="#154360", fg="white",
              width=20, height=4, bd=3, relief="solid").place(x=600, y=100)

    tk.Button(janela, text="Ver suas mercadorias\nestocadas", font=("Arial", 14, "bold"), bg="#154360", fg="white",
              width=20, height=4, bd=3, relief="solid").place(x=850, y=100)
    
    tk.Button(janela, text="Deletar conta", font=("Arial", 14, "bold"), bg="red", fg="white",
              width=20, height=4, bd=3, relief="solid").place(x=750, y=500)
    
    tk.Button(janela, text="Deletar conta", font=("Arial", 14, "bold"), bg="red", fg="white",
              width=20, height=4, bd=3, relief="solid").place(x=750, y=500)
    
    tk.Button(janela, text="Rastrear mercadoria\n(envio via correios)", font=("Arial", 14, "bold"), bg="green", fg="white",
              width=20, height=4, bd=3, relief="solid").place(x=35, y=425)
